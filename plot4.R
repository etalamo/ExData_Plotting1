...
par(mfrow = c(2,2))
#1
plot(ds1$datetime,ds1$globalactivepower, type="l",xlab="",ylab="Global Active Power")

#2
plot(ds1$datetime,ds1$voltage, type="l",xlab="datetime",ylab="Voltage")
#3
...
#4
plot(ds1$datetime,ds1$globalreactivepower, type="l",
